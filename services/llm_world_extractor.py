...
class LLMWorldExtractor:
    ...
    def _build_prompt(
        ...
        return (
            ...
            "\n"
            "IMPORTANTE SOBRE owner_id Y location_id:\n"
            "- Si la narrativa confirma que una instancia deja de "
            "pertenecer a una entidad, usa \"owner_id\": null.\n"
            "- Si la narrativa confirma que una instancia deja de estar "
            "en una ubicación, usa \"location_id\": null.\n"
            "- No omitas owner_id o location_id cuando la narrativa "
            "confirma explícitamente que ese valor debe quedar vacío.\n"
            "- No uses null simplemente porque desconozcas el propietario "
            "o la ubicación.\n"
            "- null significa que el valor se elimina explícitamente.\n"
            "\n"
            "Ejemplo: si Darian deja una jarra sobre una mesa y la jarra "
            "deja de estar en su inventario, pero la narrativa no identifica "
            "la mesa como una entidad con ID conocido, registra el cambio "
            "explícitamente usando null en el campo que corresponda y "
            "conserva únicamente los campos cuyo cambio esté confirmado.\n"
            "\n"
            ...
            "no conoces.\n"
            "Ejemplo conceptual:\n"
            "- \"Darian entrega la espada a Neria\" -> "
            "transfer_item con new_owner_id=ID de Neria.\n"
            "- \"Darian deja la espada en el suelo\" -> "
            "update_item_instance con location_id=null si no existe "
            "una entidad de ubicación identificable.\n"
            "- \"Darian recoge la espada del suelo\" -> "
            "update_item_instance con owner_id=ID de Darian si pasa "
            "a ser de su propiedad.\n"
            "- Si solo se describe dónde está físicamente el objeto "
            "pero no existe una entidad de ubicación con ID conocido, "
            "no inventes un location_id.\n"
            "\n"
